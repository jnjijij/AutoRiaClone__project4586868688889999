...
LEXERS = {
    ...
    'DockerLexer': ('pip._vendor.pygments.lexers.configs', 'Docker', ('docker', 'dockerfile'), ('Dockerfile', '*.docker'), ('text/x-dockerfile-configs',)),
    ...
    'KconfigLexer': ('pip._vendor.pygments.lexers.configs', 'Kconfig', ('kconfig', 'menuconfig', 'linux-configs', 'kernel-configs'), ('Kconfig*', '*Config.in*', 'external.in*', 'standard-modules.in'), ('text/x-kconfig',)),
    ...
    'UnixConfigLexer': ('pip._vendor.pygments.lexers.configs', 'Unix/Linux configs files', ('unixconfig', 'linuxconfig'), (), ()),
